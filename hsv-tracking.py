...
cv2.moveWindow('TrackBars',700,0)
cv2.createTrackbar('hueLower', 'TrackBars',80,255,nothing)
cv2.createTrackbar('hueUpper', 'TrackBars',180,255,nothing)
cv2.createTrackbar('satLow', 'TrackBars',255,255,nothing)
cv2.createTrackbar('satHigh', 'TrackBars',255,255,nothing)
cv2.createTrackbar('valLow', 'TrackBars',110,255,nothing)
...
try:
    ...
    while True:
        ...
        # ptz=cv2.cvtColor(frame3,cv2.COLOR_BGR2RGBA).astype(np.float32)
